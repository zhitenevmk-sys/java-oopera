...
public class Theatre {
    ...
    public static void main(String[] args) {
        ...
        Actor actorFourth = new Actor("Владимир", "Романов",175, Person.GENDER.MALE); // Для теста выбора замены из нескольких актеров
        ...
        ballet.setChoreographer(new Person("Алексей", "Кривоногов", Person.GENDER.MALE));
        ...
        musicalShow.setMusicAuthor(new Person("Матвей", "Глухих", Person.GENDER.MALE));
        ...
        show.replaceActor(actorSecond, "Высокая");// замена актеров
        show.printListOfActors();

        show.replaceActor(actorThird, "Романов");// отработка замены с однофамильцами
        show.printListOfActors();

        operaShow.replaceActor(actorSecond, "Романов");// замена несуществующего актеров
        operaShow.printListOfActors();
